...
orangeLower = np.array([20, 150, 255]) # 10, 150,20
orangeUpper = np.array([35, 255, 255]) # 30, 255,255

# HSV thresholds for purple
purpleLower = np.array([130, 75, 20]) # 130
purpleUpper = np.array([170, 255, 255]) # 170
...
def takeImageSample(cam): # requires camera reading from
    ...
    cv2.rectangle(rawFrame, (0,0), (300, 300), (255, 0, 0), 4)
    cv2.rectangle(gridFrameOrange, (0,0), (300, 300), (0, 165, 255), 4)
    cv2.rectangle(gridFramePurple, (0,0), (300, 300), (128, 0, 128), 4)
    cv2.rectangle(orangeMask, (0,0), (300, 300), (255, 255, 255), 4)
    cv2.rectangle(purpleMask, (0,0), (300, 300), (255, 255, 255), 4)
